...
class ColorViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    @IBOutlet var laColorFilter: UILabel!
    
    var lang:String!
    var filterName = ["Pink","Blue","Black","White","Green","Red","Yellow","Purple","Orange","Grey"]
    ...
    override func viewDidLoad() {
        ...
        self.laColorFilter.text = "Color".localizableString(loc: lang)
